...
// ── Nav items — scroll to section IDs on the page ────────
const NAV_ITEMS = [
...
export default function Navbar({ scrolled }) {
  ...
  const [activeNav, setActiveNav]     = useState(null); // tracks which button was last clicked
  ...
  return (
    <nav ref={navRef}
      ...
      <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
            ...
            return (
              <li key={nav.label} className="relative"
                ...
                <button
                  ...
                  style={{
                    // Black pill button, white text — always
                    background: "#111111",
                    color: "#FFFFFF",
                    borderRadius: 999,
                    padding: "8px 20px",
                    ...
                    cursor: "pointer",
                    transition: "all 0.2s",
                    // Underline indicator when section is active
                ...
                {activePanel === nav.label && NAV_PANELS[nav.label] && (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: `0 24px 60px ${t.chocolateDeep}66`,
                      border: `1px solid ${t.chocolateMid}50`,
                      position: "absolute",
                      top: 48,
                      left: "50%",
                    ...
                    <p style={{ color:t.chocolateLight, fontFamily:t.fontBody, fontSize:10, letterSpacing:"0.25em", textTransform:"uppercase", marginBottom:12 }}>
                      {nav.label}
                    </p>
        ...
        <button onClick={() => setMobile(!mobile)} className="md:hidden p-2">
          <div className="space-y-1.5">
            {[0,1,2].map(i => (
              <span key={i}
                style={{ background: isScrolled ? t.chocolateDeep : t.cream, transition:"background 0.3s" }}
      ...
      {/* Mobile menu */}
      {mobile && (
        <div style={{ background:t.cream, borderTop:`1px solid ${t.beigeDark}40` }}
